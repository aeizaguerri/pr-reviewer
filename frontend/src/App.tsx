...
import type { HealthResponse, ProviderInfo } from "./api/types";
...
export default function App() {
  const [health, setHealth] = useState<AsyncState<HealthResponse>>({ status: "loading" });
  const [providers, setProviders] = useState<AsyncState<ProviderInfo[]>>({ status: "loading" });
  ...
  return (
    <main className="app-shell">
      <section className="hero-card" aria-labelledby="app-title">
        ...
        <p>
          Docker-first Vite + React + TypeScript foundation for the production frontend.
        </p>
      </section>
